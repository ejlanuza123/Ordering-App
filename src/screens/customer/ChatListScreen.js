...
import { View, Text, FlatList, TouchableOpacity, StyleSheet, ActivityIndicator, RefreshControl, Image, AppState, Modal, Alert } from 'react-native';
    ...
    return (
      ...
      >
        ...
        <View style={styles.avatarWrap}>
          <View style={[styles.avatarRing, { backgroundColor: isDarkMode ? colors.surfaceElevated : '#EAF1FF' }]}>
            {avatarSource ? (
        ...
        <View style={styles.conversationContent}>
          <View style={styles.conversationHeader}>
            <View style={styles.titleBlock}>
              <Text style={[styles.conversationName, { color: colors.textPrimary }, isUnread && styles.unreadText]}>
                {otherName}
              </Text>
              {isClosed && (
          ...
          {item.type === 'customer_rider' && item.orders && (
            <Text style={[styles.conversationMeta, { color: colors.textSecondary }]}>
        ...
        {isSelectionMode ? (
          ...
          <View style={[styles.header, { paddingTop: 14 }]}>
            <View style={styles.headerTextBlock}>
              ...
              <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>My Chats</Text>
              <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>Keep track of rider conversations tied to your orders</Text>
            </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={[styles.emptyContainer, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              ...
              <Text style={[styles.emptySubtext, { color: colors.textSecondary }]}>Start a chat with a rider from your orders</Text>
            </View>
          }
        />
